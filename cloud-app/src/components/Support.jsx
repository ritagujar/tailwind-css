  ...
  return (
    <div className="w-full mt-24">
      ...
      <div className="max-w-[1240px] mx-auto text-white relative">
        ...
        <div className="grid grid-cols-1 relative gap-x-8 gap-y-16 lg:grid-cols-3 px-4 pt-12 sm:pt-20 text-black">
          <div className="bg-white rounded-xl shadow-2xl">
            ...
            <div className="bg-slate-100 pl-8 py-4">
              <p className="flex text-indigo-600 font-bold text-center">
